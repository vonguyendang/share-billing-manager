const translations = {
    vi: {
        ...
        'setting_reminder_desc1': 'Các con số cách nhau bởi dấu phẩy. Dương = Sắp đến hạn. 0 = Đến hạn. Âm = Quá hạn. (Hệ thống tự động khóa tài khoản vào ngày âm nhỏ nhất)',
        'setting_reminder_desc2': 'Ví dụ: 7,3,1,0,-2,-4 (Ngày -4 sẽ bị khóa tài khoản)',
        ...
        'setting_admin_email_title': 'Email thông báo Admin (Khi có khách báo thanh toán)',
        'setting_enable_admin_email': 'Bật gửi email cho Admin khi có báo thanh toán',
        'setting_admin_email_to': 'Email Nhận (To)',
        'setting_admin_email_cc': 'CC (Nhiều email cách nhau dấu phẩy - Tùy chọn)',
        'setting_admin_email_bcc': 'BCC (Nhiều email cách nhau dấu phẩy - Tùy chọn)',
        'setting_vietqr': 'Cấu hình thanh toán VietQR',
        'setting_test_title': 'Kiểm tra Thông báo (Test)',
        'setting_test_desc': 'Gửi thử thông báo mẫu để xem trước hiển thị trên Email và Telegram. Đảm bảo bạn đã lưu cấu hình Liên hệ và Telegram trước khi test.',
        'lbl_test_type': 'Chọn Loại thông báo để Test:',
        'test_opt_reminder': 'Nhắc hạn thanh toán',
        'test_opt_payment_user': 'Khách báo thanh toán (User Notification)',
        'test_opt_payment_approve': 'Duyệt thanh toán thành công',
        'test_opt_payment_reject': 'Từ chối thanh toán',
        'test_opt_cancel_user': 'Khách Hủy gia hạn',
        'lbl_test_lang': 'Ngôn ngữ Test:',
        'lbl_test_email': 'Email nhận Test:',
        'ph_test_email': 'Nhập email cá nhân của bạn...',
        'btn_send_test': 'Gửi Test ngay',
        'btn_sending': 'Đang gửi...',
        'msg_test_email_req': 'Vui lòng nhập email nhận test!',
        'msg_test_success': 'Đã gửi thông báo test thành công! Hãy kiểm tra Email (và Telegram nếu có cấu hình).',
        'msg_test_err': 'Lỗi gửi test: ',
        ...
        'setting_language': 'Ngôn ngữ Thông báo (Email / Telegram)',
        'setting_customer_lang': 'Ngôn ngữ gửi cho Khách hàng (Email)',
        'setting_admin_lang': 'Ngôn ngữ gửi cho Admin (Telegram & Email Admin)',
        'lang_bilingual': 'Song ngữ (Việt - Anh)',
        ...
        'portal_lbl_cycle': 'Chu kỳ thanh toán:',
        'portal_cycle_month_unit': 'tháng',
    ...
    en: {
        ...
        'setting_reminder_desc1': 'Comma-separated numbers. Positive = Upcoming. 0 = Due today. Negative = Overdue. (Auto-suspension triggers on the most negative day)',
        'setting_reminder_desc2': 'Example: 7,3,1,0,-2,-4 (Account suspends at -4)',
        ...
        'setting_admin_email_title': 'Admin Email Notification (When customer reports payment)',
        'setting_enable_admin_email': 'Enable email notification for Admin on payment report',
        'setting_admin_email_to': 'Recipient Email (To)',
        'setting_admin_email_cc': 'CC (Comma-separated emails - Optional)',
        'setting_admin_email_bcc': 'BCC (Comma-separated emails - Optional)',
        'setting_vietqr': 'VietQR Payment Configuration',
        'setting_test_title': 'Test Notifications',
        'setting_test_desc': 'Send a sample notification to preview its display on Email and Telegram. Make sure you have saved your Contact and Telegram configurations before testing.',
        'lbl_test_type': 'Select Notification Type to Test:',
        'test_opt_reminder': 'Payment Reminder',
        'test_opt_payment_user': 'Customer Reported Payment (User)',
        'test_opt_payment_approve': 'Payment Approved',
        'test_opt_payment_reject': 'Payment Rejected',
        'test_opt_cancel_user': 'Customer Cancelled Renewal',
        'lbl_test_lang': 'Test Language:',
        'lbl_test_email': 'Email to receive Test:',
        'ph_test_email': 'Enter your personal email...',
        'btn_send_test': 'Send Test Now',
        'btn_sending': 'Sending...',
        'msg_test_email_req': 'Please enter an email to receive the test!',
        'msg_test_success': 'Test notification sent successfully! Please check your Email (and Telegram if configured).',
        'msg_test_err': 'Test sending error: ',
        ...
        'setting_language': 'Notification Language (Email / Telegram)',
        'setting_customer_lang': 'Language for Customer (Email)',
        'setting_admin_lang': 'Language for Admin (Telegram & Admin Email)',
        'lang_bilingual': 'Bilingual (Việt - English)',
        ...
        'portal_lbl_cycle': 'Billing Cycle:',
        'portal_cycle_month_unit': 'months',
        ...
        'portal_btn_switch_bank': 'Switch Bank',
        'portal_hint_switch_bank': '(Tap to switch if bank is down)',
        'portal_tip_title': 'Tip:',
        'portal_tip_switch_bank': 'If the current bank is under maintenance and cannot receive transfers, tap the Switch Bank button below the QR code to use the alternative bank.',
